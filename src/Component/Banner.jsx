  ...
  return (
    <div className="bg-[#131212]">
      <div className="container">
        <div className="py-[100px] sm:py-[191px] relative flex items-center justify-between flex-col">
          <h1 className="text-white font-bold text-[54px] sm:text-[72px] text-center font-Syne relative z-10">
